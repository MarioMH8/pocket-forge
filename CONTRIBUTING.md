# Contributing to Pocket Forge

Thank you for your interest in contributing to **Pocket Forge** — A toolkit and visual authoring environment for original,
creature-collection role-playing games.
...
1. **Open an issue** using the appropriate template ([Bug Report](https://github.com/MarioMH8/pocket-forge/issues/new?template=bug_report.yml) or [Feature Request](https://github.com/MarioMH8/pocket-forge/issues/new?template=feature_request.yml))
...
```bash
git clone https://github.com/MarioMH8/pocket-forge.git
cd pocket-forge
bun install
```
...
Use [GitHub Discussions](https://github.com/MarioMH8/pocket-forge/discussions) — not issues — for questions, ideas, and general conversation.
