...
1. Open an issue using the [Bug Report](https://github.com/MarioMH8/pocket-forge/issues/new?template=bug_report.yml) or [Feature Request](https://github.com/MarioMH8/pocket-forge/issues/new?template=feature_request.yml) template.
